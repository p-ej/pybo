...
def comment_create_question(request, question_id):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            comment.question = question # 댓글은 질문에 달리는 것이므로 comment.question = question와 같이 Comment 모델의 question 속성에 질문 객체를 저장했다.
            comment.save()
...
def comment_modify_question(request, comment_id):
    """
    pybo 질문댓글수정
    GET 방식이면 기존 댓글을 조회하여 폼에 반영하고 POST 방식이면 입력된 값으로 댓글을 업데이트한다
    """
